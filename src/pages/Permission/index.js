...
export default class Order extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Card>
          <Button type="primary" onClick={this.handleRole} style={ButtonStyle}>创建角色</Button>
          <Button type="primary" onClick={this.handlePermission} style={ButtonStyle}>设置权限</Button>
