...
export default class BikeMap extends React.Component {
  ...
  renderMap(res) {
    ...
    // 添加起始图标
    let startPoiIcon = new window.BMap.Icon('/assets/start_point.png', new window.BMap.Size(36, 42), {
      imageSize: new window.BMap.Size(36, 42),
      anchor: new window.BMap.Size(18, 42)
    })
    let startBikeMarker = new window.BMap.Marker(startPoint, {icon: startPoiIcon});
    this.map.addOverlay(startBikeMarker);

    //
    let endPoiIcon = new window.BMap.Icon('/assets/end_point.png', new window.BMap.Size(36, 42), {
      imageSize: new window.BMap.Size(36, 42),
      anchor: new window.BMap.Size(18, 42)
    })
    let endBikeMarker = new window.BMap.Marker(endPoint, {icon: endPoiIcon});
    this.map.addOverlay(endBikeMarker);
